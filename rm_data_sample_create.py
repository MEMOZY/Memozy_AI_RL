...
image_files = sorted([f for f in os.listdir(image_folder) if f.lower().endswith(('png', 'jpg', 'jpeg'))])[:10] # 10장만 사용

# 출력 파일 경로
output_path = "./data/RM_data/caption/gpt_sample_output.jsonl"
...
with open(output_path, "w", encoding="utf-8") as f:
    for filename in image_files:
        ...
        for _ in range(5):
            ...
            user_dialog = f"오늘 {place}에 갔다. {people} 놀러갔어. 기분은 {mood}."
